...
<div class="card-box mb-30">
    <div class="pd-20">
        ...
        <a href="{{url('acara/ibadah_raya/tambah_acara')}}" class="btn btn-primary pull-right"
    ...
    <div class="pd-20 card-box mb-30">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <th scope="row">1</th>
                    <td>Telah Berpulang Saudara X-X-X</td>
                    <td>Saudara X-X-X telah meninggal dunia pada tanggal 25-07-2019</td>
                    <td>25-07-2019</td>
                    <td>
                        <div class="dropdown">
