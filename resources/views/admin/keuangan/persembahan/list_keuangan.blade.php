...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Data Persembahan Mingguan</h4>
        <a href="{{url('keuangan/persembahan/tambah_keuangan')}}" class="btn btn-primary pull-right"
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                ...
                                <a class="dropdown-item" href="{{ url('keuangan/persembahan/edit_keuangan'.$value->id) }}"><i class="dw dw-edit2"></i> Edit</a>
                                <a class="dropdown-item" href="{{ url('keuangan/persembahan/hapus_keuangan/{id}'.$value->id) }}"><i class="dw dw-delete-3"></i> Delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
